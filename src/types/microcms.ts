...
export interface Activity extends MicroCMSDate {
  ...
  filterAgeGroup?: 'adults-only' | 'all-ages' | 'ages-3-and-up' | 'elementary-school-and-up' | 'middle-school-and-up' | ('adults-only' | 'all-ages' | 'ages-3-and-up' | 'elementary-school-and-up' | 'middle-school-and-up')[]; // 配列形式（旧データ）にも対応
}
