...
export const activities: Activity[] = [
  {
    ...
    about: [
      ...
      { term: '料金', description: '4,000円〜5,000円' },
      { term: '実施可能天気', description: '晴れ・曇り' },
      { term: 'ご予約', description: '要予約' },
  ...
  },
  {
    ...
    about: [
      { term: '対象年齢', description: '8歳以上' },
      { term: '実施時期', description: '春・夏・秋' },
      { term: '人数', description: '1名〜10名' },
      { term: '所要時間', description: '3時間' },
      { term: '料金', description: '1,500円' },
      { term: '実施可能天気', description: '晴れ・曇り' },
      { term: 'ご予約', description: '予約不要' },
  ...
  },
  {
    ...
    about: [
      ...
      { term: '料金', description: '2,500円〜3,000円' },
  ...
  // === フィルタリング機能テスト用デモデータ ===
  {
    ...
    about: [
      ...
      { term: '実施時期', description: '春・夏・秋' },
      { term: '人数', description: '1名〜12名' },
      { term: '所要時間', description: '1時間' },
      { term: '料金', description: '2,800円' },
      { term: '実施可能天気', description: '晴れ・曇り' },
      { term: 'ご予約', description: '予約不要' },
  ...
  },
  {
    ...
    about: [
      { term: '対象年齢', description: '8歳以上' },
      { term: '実施時期', description: '通年' },
      { term: '人数', description: '1名〜6名' },
      { term: '所要時間', description: '3時間' },
      { term: '料金', description: '4,000円〜5,500円' },
      { term: '実施可能天気', description: '晴れ・曇り・小雨' },
      { term: 'ご予約', description: '要予約' },
  ...
  },
  {
    ...
    about: [
      ...
      { term: '所要時間', description: '1時間30分' },
      { term: '料金', description: '2,500円〜3,200円' },
  ...
  },
  {
    ...
    about: [
      { term: '対象年齢', description: '6歳以上' },
      { term: '実施時期', description: '通年' },
      { term: '人数', description: '2名〜8名' },
      { term: '所要時間', description: '2時間' },
      { term: '料金', description: '3,500円〜4,200円' },
      { term: '実施可能天気', description: '晴れ・曇り・雨天' },
      { term: 'ご予約', description: '要予約' },
